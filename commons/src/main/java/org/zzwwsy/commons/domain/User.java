package org.zzwwsy.commons.domain;
...
public class User {
	...
	@GeneratedValue(generator = "uuid2") // 使用名为 uuid2 的主键生成器
	...
	public Date getSubTitme() {
		return subTitme;
	}

	public void setSubTitme(Date subTitme) {
		this.subTitme = subTitme;
	}
