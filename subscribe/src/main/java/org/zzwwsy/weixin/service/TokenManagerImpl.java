...
import org.zzwwsy.commons.domain.ResponseError;
import org.zzwwsy.commons.domain.ResponseMessage;
...
public class TokenManagerImpl implements TokenManager {
	...
	public String getToken(String account) {
		...
		String appid = "wx47be31ed1b8b7253";
		String appsecret = "bf2ece8f24f6a26c8407c9cd36b0aa9e";
		...
		HttpClient hc = HttpClient.newBuilder()//
				.version(Version.HTTP_1_1)//HTTP的协议版本号0
				.build();
