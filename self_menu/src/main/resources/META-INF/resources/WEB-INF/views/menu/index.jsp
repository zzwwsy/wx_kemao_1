...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/kemao_1/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/kemao_1/menu/js/jquery.js"></script>
<script type="text/javascript" src="/kemao_1/menu/js/vue.js"></script>
<script type="text/javascript" src="/kemao_1/menu/js/menu.js"></script>
